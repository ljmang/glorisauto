...
const SEARCH_TEXTS: Record<SearchLocale, SearchStaticText> = {
  ...
  vi: {
    ...
    aboutUsContent: 'Nội dung giới thiệu về Gloris',
    brandStory: 'Câu chuyện thương hiệu',
    brandStoryContent: 'Nội dung câu chuyện thương hiệu',
    dealer: 'Đại lý',
    dealerContent: 'Thông tin dành cho đại lý',
    production: 'Sản xuất',
    productionContent: 'Thông tin về hoạt động sản xuất',
    products: 'Sản phẩm',
    productsContent: 'Danh sách sản phẩm',
    insights: 'Góc nhìn',
    insightsContent: 'Danh sách bài viết và góc nhìn',
    videos: 'Video',
    videosContent: 'Video giới thiệu sản phẩm và ứng dụng thực tế',
    support: 'Hỗ trợ',
    supportContent: 'Nội dung trung tâm hỗ trợ',
    contact: 'Liên hệ với chúng tôi',
    contactContent: 'Biểu mẫu liên hệ',
    downloads: 'Tài liệu tải xuống',
    downloadsContent: 'Danh sách tài liệu có thể tải xuống',
    helpCenter: 'Trung tâm trợ giúp',
    helpCenterContent: 'Danh sách danh mục trung tâm trợ giúp',
    privacy: 'Chính sách bảo mật',
    privacyContent: 'Nội dung chính sách bảo mật',
  },
};
